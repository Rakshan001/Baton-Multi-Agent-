...
export const DEMO_MEMORY: MemoryFactStatus[] = [
  {
    ...
    agent: "claude", author: "priya@example.com", task: "fix-duplicate-charges", createdAt: ago(2),
  ...
  },
  {
    ...
    agent: "cursor", author: "sam@example.com", task: null, createdAt: ago(5),
  ...
  },
  {
    ...
    agent: "claude", author: "priya@example.com", task: "feature-flag-system", createdAt: ago(9),
  ...
  },
  {
    ...
    agent: "codex", author: "jules@example.com", task: "auth-cleanup", createdAt: ago(21),
  ...
  },
  {
    ...
    agent: "gemini", author: "sam@example.com", task: "export-oom-fix", createdAt: ago(30),
